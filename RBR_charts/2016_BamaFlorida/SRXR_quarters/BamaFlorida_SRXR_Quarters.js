...
var srxrq_csv_url = "https://couchux.github.io/RBR_charts/2016_BamaFlorida/SRXR_quarters/BamaFlorida_SRXR_Quarters.csv"
...
function srxrqCharts() {
  ...
  srxrqChart(srxrq_csv_url, "Florida", "2")
}
...
var layout = {
  ...
  barMarginBoost: 1.1,
  srWidthScale: 0.7,
  leagueSR: 0.39, //update this peridically for NCAA Success Rate averages
  leagueSRwidth: 3,
  qLabelX: 8,
  srLabelX: 24,
  secondLabelX: 40,
