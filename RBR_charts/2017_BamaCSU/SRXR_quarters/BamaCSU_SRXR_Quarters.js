...
var srxrq_csv_url = "https://couchux.github.io/RBR_charts/2017_BamaCSU/SRXR_quarters/BamaCSU_SRXR_Quarters.csv"
...
function srxrqCharts() {
  ...
  srxrqChart(srxrq_csv_url, "Colorado State", "2")
}
...
function csv_response(which_team, what_order, error, data) {
  if (error) {
    ...
    data.forEach(function(d) {
      ...
      if (d.Team == "Colorado State") {
        d.Team = "Colorado State"
      }
      if (d.Quarter !== "Game") {
