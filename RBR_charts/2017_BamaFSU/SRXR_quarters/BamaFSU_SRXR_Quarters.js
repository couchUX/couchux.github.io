...
var srxrq_csv_url = "https://couchux.github.io/RBR_charts/2017_BamaFSU/SRXR_quarters/BamaFSU_SRXR_Quarters.csv"
...
function srxrqCharts() {
  ...
  srxrqChart(srxrq_csv_url, "Florida State", "2")
}
...
function csv_response(which_team, what_order, error, data) {
  if (error) {
    ...
    data.forEach(function(d) {
      ...
      if (d.Team == "Florida State") {
        d.Team = "Florida State"
      }
      if (d.Quarter !== "Game") {
